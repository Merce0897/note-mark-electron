...
export const MarkDownEditor = (): JSX.Element | null => {
  ...
  return (
    <MDXEditor
      ...
      contentEditableClassName="outline-none min-h-screen max-w-none text-lg px-8 py-5 caret-yellow-500 prose prose-invert prose-p:my-3 prose-p:leading-relaxed prose-headings:my-4
